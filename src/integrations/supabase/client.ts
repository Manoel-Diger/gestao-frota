// ARQUIVO: src/integrations/supabase/client.ts (Versão que FUNCIONA no Localhost)

import { createClient } from '@supabase/supabase-js';
import type { Database } from './types';

// Lendo as variáveis de ambiente COM o prefixo VITE_ (Necessário para o Vite/Localhost)
